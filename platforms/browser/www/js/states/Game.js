...
Match3.GameState = {
  ...
  dropBlock: function(sourceRow, targetRow, col) {
    ...
    var targetY = 36 + targetRow * (this.BLOCK_SIZE + 6);
  ...
  dropReserveBlock: function(sourceRow, targetRow, col) {
    ...
    var y = -(this.BLOCK_SIZE + 6) * this.board.RESERVE_ROW + sourceRow * (this.BLOCK_SIZE);
    ...
    block1Movement.onComplete.add(function() {
      ...
      if (!this.isReverseSwap) {
        ...
        if (chains.length > 0) {
          ...
          this.isReverseSwap = true;
          this.swapBlocks(block1, block2);
        }
      } else {
        this.isReverseSwap = false;
        this.clearSelection();
      }
